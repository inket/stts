...
class AWSCodeStar: AWSNamedService, SubService {
    let name = "AWS CodeStar"
    let ids = Set<String>([
        "codestar-ap-northeast-1",
        "codestar-ap-northeast-2",
        "codestar-ap-southeast-1",
        "codestar-ap-southeast-2",
        "codestar-ca-central-1",
        "codestar-eu-central-1",
        "codestar-eu-north-1",
        "codestar-eu-west-1",
        "codestar-eu-west-2",
        "codestar-us-east-1",
...
class AWSElementalMediaConvert: AWSNamedService, SubService {
    let name = "AWS Elemental MediaConvert"
    let ids = Set<String>([
        "mediaconvert-af-south-1"
    ])
}

class AWSElementalMediaTailor: AWSNamedService, SubService {
    let name = "AWS Elemental MediaTailor"
    let ids = Set<String>([
        "mediatailor-af-south-1"
    ])
}
...
class AWSFaultInjectionSimulator: AWSNamedService, SubService {
    let name = "AWS Fault Injection Simulator"
    let ids = Set<String>([
        "fis-af-south-1",
        "fis-ap-east-1",
        "fis-ap-northeast-1",
...
class AWSIoTRoboRunner: AWSNamedService, SubService {
    let name = "AWS IoT RoboRunner"
    let ids = Set<String>([
        "iotroborunner-eu-central-1",
        "iotroborunner-us-east-1"
    ])
}
...
class AmazonCodeWhisperer: AWSNamedService, SubService {
    let name = "Amazon CodeWhisperer"
    let ids = Set<String>([
...
class AmazonGameLift: AWSNamedService, SubService {
    let name = "Amazon GameLift"
    let ids = Set<String>([
        "gamelift-af-south-1",
        "gamelift-ap-east-1",
...
class AmazonKinesisAnalytics: AWSNamedService, SubService {
    let name = "Amazon Kinesis Analytics"
    let ids = Set<String>([
...
class AmazonWorkSpacesWeb: AWSNamedService, SubService {
    let name = "Amazon WorkSpaces Web"
    let ids = Set<String>([
