...
class PlusIcon: NSView {
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        NSBezierPath(rect: NSRect(x: 3, y: 22, width: 40, height: 2)).fill()
        NSBezierPath(rect: NSRect(x: 22, y: 3, width: 2, height: 40)).fill()
    }
}

class TrashIcon: NSView {
    var color: NSColor = NSColor(calibratedRed: 0.9, green: 0.78, blue: 0.56, alpha: 1) {
        didSet {
            self.needsDisplay = true
        }
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        let bin = NSBezierPath()
        bin.move(to: NSPoint(x: 30, y: 3))
        bin.line(to: NSPoint(x: 16, y: 3))
        bin.curve(to: NSPoint(x: 9, y: 10),
                  controlPoint1: NSPoint(x: 12.14, y: 3),
                  controlPoint2: NSPoint(x: 9, y: 6.14))
        bin.line(to: NSPoint(x: 9, y: 36))
        bin.line(to: NSPoint(x: 11, y: 36))
        bin.line(to: NSPoint(x: 11, y: 10))
        bin.curve(to: NSPoint(x: 16, y: 5),
                  controlPoint1: NSPoint(x: 11, y: 7.24),
                  controlPoint2: NSPoint(x: 13.24, y: 5))
        bin.line(to: NSPoint(x: 30, y: 5))
        bin.curve(to: NSPoint(x: 35, y: 10),
                  controlPoint1: NSPoint(x: 32.76, y: 5),
                  controlPoint2: NSPoint(x: 35, y: 7.24))
        bin.line(to: NSPoint(x: 35, y: 36))
        bin.line(to: NSPoint(x: 37, y: 36))
        bin.line(to: NSPoint(x: 37, y: 10))
        bin.curve(to: NSPoint(x: 30, y: 3),
                  controlPoint1: NSPoint(x: 37, y: 6.14),
                  controlPoint2: NSPoint(x: 33.86, y: 3))
        bin.close()
        bin.fill()

        NSBezierPath(rect: NSRect(x: 7, y: 35.01, width: 32, height: 2)).fill()
        NSBezierPath(rect: NSRect(x: 17, y: 11.01, width: 2, height: 18)).fill()
        NSBezierPath(rect: NSRect(x: 27, y: 11.01, width: 2, height: 18)).fill()

        let lidHandle = NSBezierPath()
        lidHandle.move(to: NSPoint(x: 32, y: 36.5))
        lidHandle.line(to: NSPoint(x: 30, y: 36.5))
        lidHandle.line(to: NSPoint(x: 30, y: 39.25))
        lidHandle.curve(to: NSPoint(x: 28, y: 41),
                        controlPoint1: NSPoint(x: 30, y: 40.22),
                        controlPoint2: NSPoint(x: 29.1, y: 41))
        lidHandle.line(to: NSPoint(x: 18, y: 41))
        lidHandle.curve(to: NSPoint(x: 16, y: 39.25),
                        controlPoint1: NSPoint(x: 16.9, y: 41),
                        controlPoint2: NSPoint(x: 16, y: 40.22))
        lidHandle.line(to: NSPoint(x: 16, y: 36.5))
        lidHandle.line(to: NSPoint(x: 14, y: 36.5))
        lidHandle.line(to: NSPoint(x: 14, y: 39.25))
        lidHandle.curve(to: NSPoint(x: 18, y: 43),
                        controlPoint1: NSPoint(x: 14, y: 41.32),
                        controlPoint2: NSPoint(x: 15.79, y: 43))
        lidHandle.line(to: NSPoint(x: 28, y: 43))
        lidHandle.curve(to: NSPoint(x: 32, y: 39.25),
                        controlPoint1: NSPoint(x: 30.21, y: 43),
                        controlPoint2: NSPoint(x: 32, y: 41.32))
        lidHandle.line(to: NSPoint(x: 32, y: 36.5))
        lidHandle.close()
        lidHandle.fill()
    }
}
...
class RefreshIcon: NSView {
    var color: NSColor = NSColor(calibratedWhite: 0, alpha: 0.4) {
        didSet {
            self.needsDisplay = true
        }
    }
